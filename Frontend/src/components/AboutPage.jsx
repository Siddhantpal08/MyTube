    ...
    return (
        <div className="max-w-4xl mx-auto p-4 text-gray-900 dark:text-white">
            <div className="text-center mb-12">
                ...
                <p className="text-gray-500 dark:text-gray-400 mt-2">A Full-Stack Video Sharing Platform</p>
            </div>
            <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg space-y-4 border border-gray-200 dark:border-gray-700">
                <h2 className="text-2xl font-bold">Project Overview</h2>
                <p className="text-gray-700 dark:text-gray-300">MyTube is a comprehensive project built to demonstrate a full-stack development process, incorporating a robust backend API with a dynamic, responsive frontend inspired by YouTube.</p>
